...
export const employeePublishService = (data) => request.post('/employee/add', data)
...
//员工：编辑员工接口
export const employeeEditService = (data) => request.put('/employee/update', data)

// 员工：删除员工接口
export const employeeDelService = (id) =>
    request.delete('/employee/delete', { params: { id } })