...
// 整个表单的校验规则
// 1. 非空校验 required: true      message消息提示，  trigger触发校验的时机 blur(失去焦点时触发) change(值改变时触发)
...
<template>
  <!--
       ...
       el-row表示一行，一行分成24份
       el-col表示列
       (1):span="12" 代表在一行中，占12份（刚好50%）
       (2):span="6" 代表在一行中，占6份（刚好25%）
       (3):offset="3"代表在一行中，左侧margin（空出）的份数
    ...
    <el-col :span="6" :offset="3" class="form">
      ...
      >
        ...
        <el-form-item prop="roleId">
          <el-radio-group v-model="formModel.roleId" class="ml-4">
            <el-radio label="1" size="large">学生</el-radio>
            <!--              <el-radio label="2" size="large">员工</el-radio>-->
